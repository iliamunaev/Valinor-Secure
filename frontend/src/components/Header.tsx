...
// Team members data
const teamMembers = [
  { id: 1, name: 'Mike', role: 'Engineer', color: 'bg-orange-400', initials: 'M' },
  { id: 2, name: 'Jake', role: 'Designer', color: 'bg-blue-400', initials: 'J' },
  { id: 3, name: 'Sam', role: 'Manager', color: 'bg-purple-400', initials: 'S' },
];
